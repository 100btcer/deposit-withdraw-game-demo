...
// GetValidWithdrawLp is a free data retrieval call binding the contract method 0xb8cdff18.
//
// Solidity: function getValidWithdrawLp() view returns(uint256)
func (_MM *MMCaller) GetValidWithdrawLp(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _MM.contract.Call(opts, &out, "getValidWithdrawLp")
...
//
// Solidity: function getValidWithdrawLp() view returns(uint256)
func (_MM *MMSession) GetValidWithdrawLp() (*big.Int, error) {
	return _MM.Contract.GetValidWithdrawLp(&_MM.CallOpts)
}

// GetValidWithdrawLp is a free data retrieval call binding the contract method 0xb8cdff18.
//
// Solidity: function getValidWithdrawLp() view returns(uint256)
func (_MM *MMCallerSession) GetValidWithdrawLp() (*big.Int, error) {
	return _MM.Contract.GetValidWithdrawLp(&_MM.CallOpts)
}
